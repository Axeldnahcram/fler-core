...
class Training_database(object):
    ...
    def train_with_function(self, model, df: None, features:list, name_to_export:None, entity: list=['ORG','LOC','MISC', 'PER']):
        """
        ...
        return params_sk
    @staticmethod
    def do_feature_dataset(df: pd.DataFrame(), language: str='ENG', features=features_no_directory):
        for i in features:
